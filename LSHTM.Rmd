...
knitr::include_graphics("https://media.giphy.com/media/xT5LMsDBjZO6yRYTmw/giphy.gif") # Gipgyt
```
...
* More basic: 'Natural' limits to the number of people we can know. 
...
How are relationships defined, for example? (De Ruiter, 2011).

Evidence for smaller/larger structures? How to apply to fission/fusion systems? Other social network studies come up with larger numbers (and a lot of variability)
...
Sympathy group: "considered to be close friends", support group: 'considered to be close friends'.
...
```{r, out.width = "300px", echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/ZZS5xe4Y7g5eo/giphy.gif") # I can has cheezburger.
```
...
* Recruited via personal networks of Masters students (Major Nationalities: 30% Dutch, 12% Germany, 9% U.S.). 

--

* 63.4% women, $\sf{Mean_{age}}$=27, $\sf{SD_{age}}$=10, range: 18 to 83 years. --> Remains W.E.I.R.D.
...
* (net) sympathy group: no effect of personality (only language of survey)
...
* No personality effects after adjusting for control variables. Except for Honesty-Humility effects
...
* [Gephi](www.gephi.org) to calculate common social network metrics. --> Density, Clustering.
...
* "From time to time, most people discuss important matters with other people they trust. These important matters may bepersonal or social.The people with whom you discuss important matters may be friends, family or co-workers. Lookingback over the last six months, who are the people with whom you discussed matters important to you over the telephone, text or in person?"
...
* Do those who have body image issues preferentially assort with those holding similar views (with Piers Cornelissen)
...
* Questions about homogeneity in networks.
